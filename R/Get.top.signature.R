...
Get.top.signature <- function(top.num=100) {
  ...
  DEG.Glioblastoma  <- system.file("data", "DEG.Glioblastoma.rds", package = "DrWho")
  DEG.Glioblastoma = readRDS(DEG.Glioblastoma)
  DEG.H3K27M_gliomas  <- system.file("data", "DEG.H3K27M_gliomas.rds", package = "DrWho")
  DEG.H3K27M_gliomas = readRDS(DEG.H3K27M_gliomas)
  DEG.BREAST  <- system.file("data", "DEG.BREAST.rds", package = "DrWho")
  DEG.BREAST = readRDS(DEG.BREAST)
  DEG.PDAC  <- system.file("data", "DEG.PDAC.rds", package = "DrWho")
  DEG.PDAC=readRDS(DEG.PDAC)
  DEG.head_neck <- system.file("data", "DEG.head_neck.rds", package = "DrWho")
  DEG.head_neck=readRDS(DEG.head_neck)
  DEG.Prostate   <- system.file("data", "DEG.Prostate.rds", package = "DrWho")
  DEG.Prostate=readRDS(DEG.Prostate)
  DEG.lung   <- system.file("data", "DEG.lung.rds", package = "DrWho")
  DEG.lung=readRDS(DEG.lung)
  DEG.liver   <- system.file("data", "DEG.liver.rds", package = "DrWho")
  DEG.liver=readRDS(DEG.liver)
  DEG.Kindey   <- system.file("data", "DEG.Kindey.rds", package = "DrWho")
  DEG.Kindey= readRDS(DEG.Kindey)
  DEG.HNSCC   <- system.file("data", "DEG.HNSCC.rds", package = "DrWho")
  DEG.HNSCC=readRDS(DEG.HNSCC)
  DEG.Sarcoma_Osteosarcoma   <- system.file("data", "DEG.Sarcoma_Osteosarcoma.rds", package = "DrWho")
  DEG.Sarcoma_Osteosarcoma=readRDS(DEG.Sarcoma_Osteosarcoma)
  DEG.ALL <- system.file("data", "DEG.ALL.rds", package = "DrWho")
  DEG.ALL=readRDS(DEG.ALL)
  DEG.Multiple_myeloma   <- system.file("data", "DEG.Multiple_myeloma.rds", package = "DrWho")
  DEG.Multiple_myeloma=readRDS(DEG.Multiple_myeloma)
  DEG.CML  <- system.file("data", "DEG.CML.rds", package = "DrWho")
  DEG.CML=readRDS(DEG.CML)
  DEG.Neuroblastoma  <- system.file("data", "DEG.Neuroblastoma.rds", package = "DrWho")
  DEG.Neuroblastoma=readRDS(DEG.Neuroblastoma)
  DEg.CRC  <- system.file("data", "DEg.CRC.rds", package = "DrWho")
  DEg.CRC =readRDS(DEg.CRC)
  DEG.Myeloproliferative_neoplasms  <- system.file("data", "DEG.Myeloproliferative_neoplasms.rds", package = "DrWho")
  DEG.Myeloproliferative_neoplasms = readRDS(DEG.Myeloproliferative_neoplasms)
  DEG.Ovarian_cancer  <- system.file("data", "DEG.Ovarian_cancer.rds", package = "DrWho")
